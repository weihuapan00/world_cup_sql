...
--
-- Name: games fk_opponnet; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.games
    ADD CONSTRAINT fk_opponnet FOREIGN KEY (opponent_id) REFERENCES public.teams(team_id);
